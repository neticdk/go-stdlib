...
// provides flexible options for customizing the output format, including context and unified diff formats,
// through the use of formatters.
//
// # Subpackages
//
...
//     extremely large inputs or when recursion limits are reached.
//
// # Usage
//
...
// for simpler use cases. The format of the diff output is controlled by a `Formatter`.
// The default formatter produces a context diff with line numbers.
//
